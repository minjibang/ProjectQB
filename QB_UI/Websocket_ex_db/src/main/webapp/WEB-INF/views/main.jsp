...
<script type="text/javascript">
	function popupOpen(roomno,roomname) {
		var popUrl = "chat.htm?select="+roomno+"&roomname="+roomname; //팝업창에 출력될 페이지 URL       => chat.htm?select=1 & roomname=""
	...
	function connect() {
		...
		"ws://" + document.domain + ":8090/bit/login");
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li class="nav-item"><a class="nav-link" href="#"
					style="color: white"> <img id="loginimg" alt=""
						src="https://dopl-egov.commerce.utah.gov/eGov/person%20image.png">${nickname}님</a>
				</li>
			</ul>
				...
				<table>
					...
					<c:forEach var="room" items="${list}">
						...
						<tr>
							...
							<td><a href="javascript:popupOpen(${room.roomno},'${room.roomname}');">
									<input type="submit" value="채팅방 입장" id="roombtn" class="btn">	
							</a></td>
							<td><a href="roomDelete.htm?roomno=${room.roomno}" id="roomDelete" class="btn">채팅방 삭제</a>
							<td><a href="test.htm" class="btn" id="test"></a>

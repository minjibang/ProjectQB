...
public class TestManageController {
	...
	public @ResponseBody ModelAndView questionSearch(@RequestParam("lgsearchtype") String lgsearchtype,
		...
		List<QuestionDto> question = teacherService.questionSearch(lgsearchtype, mdsearchtype, smsearchtype, leveltype,
	...
	public @ResponseBody int examquestionsinsert(@RequestParam("exam_paper_num") int exam_paper_num,
		...
		int result = teacherService.examquestionsinsert(exam_paper_num, question_num, exam_question_seq,
				exam_question_score);
	...
	public String examInfoInsert(ExamInfoDto dto, String memberarray2, int exam_paper_num, HttpServletResponse response)
	...
	/* 한결 시작 */
	/*
	 * @RequestMapping("checkExam_paper.do") public @ResponseBody String
	 * examPaperCheck(@RequestParam("exam_paper_name") String exam_paper_name,
	 * 
	 * @RequestParam("member_id") String member_id) { String result =
	 * teacherService.examPaperCheck(exam_paper_name,member_id); return result; }
	 */
	...
	public @ResponseBody int examPaperUpdate(@RequestParam("exam_paper_num") int exam_paper_num,
			...
			@RequestParam("exam_paper_status") String exam_paper_status, Principal principal) {
		String member_id = principal.getName();
		int result = teacherService.examPaperUpdate(exam_paper_num, exam_paper_name, member_id, exam_paper_desc,
				exam_paper_status);
		return result;
	}
	...
	/*
	 * @RequestMapping("examQuestionSelect.do") public @ResponseBody int
	 * examQuestionSelect(@RequestParam("exam_paper_num") String exam_paper_num,
	 * 
	 * @RequestParam("question_num") String question_num) { int result =
	 * teacherService.examQuestionSelect(exam_paper_num, question_num); return
	 * result; }
	 */
	...
	public @ResponseBody int examQuestionInsert(@RequestParam("exam_paper_num") int exam_paper_num,
			...
			@RequestParam("exam_question_seq") String exam_question_seq,
			@RequestParam("exam_question_score") String exam_question_score) {
		int result = teacherService.examQuestionInsert(exam_paper_num, question_num, exam_question_seq,
				exam_question_score);
		return result;
	}
	...
	public String examScheduleUpdate(Model model, int exam_info_num) {
		 ...
		 * 
		 * List<ExamPaperDto> examPaperList; examPaperList =
		 * teacherService.examPaperList(class_num); model.addAttribute("examPaperList",
		 * examPaperList);
	...
	public @ResponseBody String teacherExamSchedultDelete(@RequestParam("exam_info_num") int exam_info_num,
			@RequestParam("currentDate") int currentDate, @RequestParam("removeData") int removeData) // @RequestBody
																										// (비동기: 객체 형태로
																										// 받아요)
	{

		/*
		 * deptService.insertDept(dto); return dto.toString();
		 */
		String result2 = "";
	...
	public @ResponseBody ModelAndView myTempExamList(@RequestParam("searchType") String searchType,
	...
	public @ResponseBody ModelAndView exampaperSearch(@RequestParam("searchType") String searchType,
			@RequestParam("keyword") String keyword, @RequestParam("begin") int begin, Principal principal) {

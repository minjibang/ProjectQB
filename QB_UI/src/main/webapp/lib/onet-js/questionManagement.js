	...
	$('#searchHelp').click(function(){
		swal({
			...
			text: "분류별, 난이도별, 문제타입별, 키워드별 검색을 지원합니다. \n \n" +
				...
				"중, 소 분류의 선택을 위해서는 해당 중, 소 분류를 포함하는 " +
				"상위 분류가 먼저 선택되어야 합니다.\n \n" +
				"2.난이도, 문제 타입 \n 검색을 원하는 난이도와 문제 타입을 선택해주세요. \n \n" +
				"3.키워드 \n 입력하신 키워드를 포함하고 있는 문제가 검색됩니다. \n" +
				"이 때, 선택하신 분류, 난이도, 문제타입이 있다면 그 선택값 내의 문제에서 키워드를 포함한 문제가 검색됩니다.\n\n" +
				"키워드를 입력하지 않고 분류, 난이도, 문제타입 선택 후 검색을 누를 시에는 선택값에 해당하는 모든 문제가 검색됩니다."
				,
			icon: "info"
		});
	});

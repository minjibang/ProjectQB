...
/*	alert($("#question_sm_category2 option:selected").val());*/
	
	var _smCategory = $("#question_sm_category2 option:selected").val();
	alert("_smCategory value=[[ " + _smCategory + " ]]");
	var _questionLevel = document.getElementById("question_level");
	var _questionName = document.getElementById("question_name");
	var _questionChoiceAnswer = document.getElementByName("question_answer");
	var _questionChoiceContent = document.getElementByName("question_choice_content");
	var _questionShortAnswer = document.getElementById("questionType2Answer");
	
	
	if ($.trim(_smCategory) == "") {
		alert("문제의 대,중,소 분류를 선택해 주세요");

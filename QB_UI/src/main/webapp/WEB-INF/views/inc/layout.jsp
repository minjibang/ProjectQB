...
<body>
	...
	<!-- 헤더 부분 --> <tiles:insertAttribute name="header" />
	<!-- 사이드바 부분 --> <tiles:insertAttribute name="sidebar" /> 
	<!-- 컨텐츠 부분 --> <tiles:insertAttribute	name="content" /> 
	</section>
...
<%-- 	<script
	...
	<script	src="${pageContext.request.contextPath}/lib/data_table.js"></script>

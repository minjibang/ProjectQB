												...
												<c:forEach items="${examScheduleList}"
													...
													<div class="exam_info_name">
														...
														<div class="view-schedule text-center">
															...
															<button type="button" class="btn btn-theme buttonGroup"
																onclick="location.href='${pageContext.request.contextPath}/teacher/examScheduleUpdate.do?class_num=${param.class_num}&exam_paper_name=${examScheduleList.exam_info_name}'">시험
																일정 수정</button>

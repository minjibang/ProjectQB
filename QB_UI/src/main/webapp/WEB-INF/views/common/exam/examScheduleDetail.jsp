...
<section id="main-content">
	<section class="wrapper site-min-height">
		<h3>
			<i class="fa fa-angle-right"></i> 시험 일정 상세보기
		</h3>
		<div class="content-panel">
			<div class="row mt">
				<div class="col-lg-5 examImgDiv">
					<img id="examImg" src="${pageContext.request.contextPath}/img/friends/fr-02.jpg">
					<h3>자바 기초 시험</h3>
					<br>
				...
				<div class="col-lg-7">
					...
					<div class="row">
						<div class="col-lg-3 clockImgDiv">
							<img id="clockImg" src="${pageContext.request.contextPath}/img/clock2.png">
						</div>
						<div class="col-lg-7">
							<br> 
							시험 시작까지 <b>03:20:17</b>  남았습니다. <br> 
							시험 시작 시간이 되면 시험 감독 버튼이 활성화됩니다.<br>
						</div>
					</div>

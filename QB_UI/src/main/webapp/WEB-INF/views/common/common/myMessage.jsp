															...
															<div class="panel-body grey-panel">
																...
																<ul class="nav nav-pills nav-stacked mail-nav">
																	<se:authorize access="hasRole('ROLE_TEACHER')">
																		<c:forEach items="${classMemberList}"
																			var="classMemberList">
																			<li id="messageSelect"><div>
																					<div class="checkbox" id="checkboxName"
																						style="text-align: left;">
																						<label> <input type="checkbox"
																							class="checkbox form-control" id="agree"
																							name="chk" value="" style="position: relative;" />
																							<img
																	...
																	<se:authorize access="hasRole('ROLE_STUDENT')">
																		<c:forEach items="${classTeacherList}"
																			...
																			<li id="messageSelect"><div>
																					<div class="checkbox" id="checkboxName"
																						...
																						<label> <input type="checkbox"
																							class="checkbox form-control" id="agree"
																							name="chk" value="${classTeacherList.member_id}"
																			...
																			<input type="hidden" id="teacher_id"
																				name="teacher_id"
																				value="${classTeacherList.member_id}" />
													...
													<div class="col-md-8">
														<div class="form-group">
															<textarea class="form-control" name=message_content
																id="message_content" placeholder="Your Message" rows="5"
																data-rule="required"
														...
														<button type="button" onclick="check()"
															class="btn btn-large btn-primary">전송</button>

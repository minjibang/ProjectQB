<%-- 
	...
	@DATE:2018-10-11
	@Author:김현이
	@Desc:강사-시험지 수정 페이지(스토리보드 25 of 41) --> 시험관리 탭에서 하나의 페이지로 따로 빼냈음
 --%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<link href="${pageContext.request.contextPath}/css/examPaperMake.css"
	rel="stylesheet"> <!-- examPaperMake 페이지와 css 겹쳐서 하나의 파일에 작성함 -->
<section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> 시험지 수정</h3>
          <div class="content-panel upsideContentPanel">
            <div class="panel-body">
                <div class="row examPaperModifyRowDiv">
                    <div class="col-lg-1 examPaperModifySubject">시험지 이름</div>
                    <div class="col-lg-11"><input type="text" class="form-control" name=""></div>
                </div>
                <div class="row examPaperModifyRowDiv examPaperModifySubject">
                    <div class="col-lg-1">설명</div>
                    <div class="col-lg-11"><textarea class="form-control" name=""></textarea>
                </div>  
            </div>
          </div>
         </div>
            ...
            <div class="">
               <div class="row content-panel">
                  ...
                  <div class="row content-panel exampaneldetailed">
                     <div class="col-lg-6" id="examBox" style="border-right:1px solid black;">
                        <div id="exam" style="text-align:left; padding-top:10px;">
                     ...
                     <button class="btn btn-large btn-primary exampaneldetailBtn" data-dismiss="modal">확인</button>
                  </div>
               </div>
            </div>
         </div>
										...
										<input type="button" class="btn btn-theme" value="시험지 수정" id="examPaperModifyBtn">
									</div>
								</div>
								<!-- 모달창 -->
								<!-- 임시저장 모달 -->
										...
										<div class="modal-content">
											...
											<form action="" method="post">
												<div class="modal-body">
													...
													시험지 이름 <input type="text" class="form-control" name=""><br> 
                                                    시험지 설명 <textarea type="textarea" class="form-control" name=""></textarea>
												</div>
												<div class="modal-footer">
													<div class="form-group">
														<div class="col-lg-offset-2 col-lg-10">
...
<!-- examPaperMake 페이지와 스크립트 겹쳐서 하나의 파일에 작성함 -->

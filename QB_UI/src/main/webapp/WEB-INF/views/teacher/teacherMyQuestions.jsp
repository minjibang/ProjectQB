							...
							<div class="row">
								...
								<div class="col-md-8">
									...
									<div id="questionTypeSelect" class="form-group">
										...
										<div class="radio">
											<label class="questionTypeRadioButton"> <input
												type="radio" class="questionTypeRadioButton"
												name="optionsRadios" id="optionsRadios1" value="option1"
												checked> 객관식
											</label> <label class="questionTypeRadioButton"> <input
									...
									<div class="form-group" id="questionMoonje">
										...
										<textarea id="moonjeTextArea" class="summernote1 form-control"
											placeholder="문제 내용을 입력해주세요." rows="5"></textarea>
									...
									<div class="form-group" id="questionChoice">
										...
										<div class="answerChoice">
											정답을 선택해주세요: <label class="checkbox-inline"> <input
										...
										<div>
											<textarea id="moonjeTextArea"
												class="summernote2 form-control"
												placeholder="1번 보기 내용을 입력해주세요." rows="3"></textarea>
											<div class="col-sm-8"></div>
											<div class="col-sm-2"></div>
										</div>
										...
										<div>
											<textarea id="moonjeTextArea"
												class="summernote2 form-control"
												placeholder="2번 보기 내용을 입력해주세요." rows="3"></textarea>
											<div class="col-sm-8"></div>
											<div class="col-sm-2"></div>
										</div>
										...
										<div>
											<textarea id="moonjeTextArea"
												class="summernote2 form-control"
												placeholder="3번 보기 내용을 입력해주세요." rows="3"></textarea>
											<div class="col-sm-8"></div>
											<div class="col-sm-2"></div>
										</div>
										...
										<div>
											<textarea id="moonjeTextArea"
												class="summernote2 form-control"
												placeholder="4번 보기 내용을 입력해주세요." rows="3"></textarea>
											<div class="col-sm-8"></div>
											<div class="col-sm-2"></div>
										</div>
									</div>

...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<link href="${pageContext.request.contextPath}/css/studentGradeManage.css" rel="stylesheet">
      ...
      <div class="tab-pane" id="chartjs">
        <div class="row mt">
          ...
          <div class="col-md-5">
            ...
            <div class="content-panel-lightgray">
              <h4><i class="fa fa-angle-right"></i> 등수 보기</h4>
...
<script src="${pageContext.request.contextPath}/lib/onet-js/studentGradeManage.js" type="text/javascript"></script>
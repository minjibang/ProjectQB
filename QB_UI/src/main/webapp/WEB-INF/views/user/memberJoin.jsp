		...
		<form class="form-signup" action="insertmember.do" method="post"
			...
			<div class="login-wrap">
				...
				<label>PASSWORD</label> <input type="password" class="form-control"
					placeholder="Password" name="member_pwd" id="member_pwd" onblur="confirmPwd()">
				<div id="pwddiv"></div>
				...
				<label>CLASS</label> <select class="form-control" name="class_name">
					...
					name="member_name" pattern="([a-z,A-Z,가-힣]){2,}" required>
				<br>    <label>E-mail</label><br>
          <input type="text" class="form-control authNumberEmail" placeholder="Class" autofocus name="member_email" >
          <button class="btn2 btn-theme05 authNumberButton">인증번호 발송</button><br><br> <label>Certification
					Number</label> <input type="text" class="form-control" placeholder="Class"
					autofocus> <br> <label>PHONE</label> <input
					type="text" class="form-control" placeholder="Class" autofocus
